...
# This pipeline (4) constructs per-season player datasets,
# collecting some selected basic player statistics available since 1980
# (e.g., eFG% / FT% / TRB / STL / BLK / AST / PTS),
...
def create_pipeline_selectedStats_from1980(start_year: int=1980, end_year: int=2025,
                                   raw_data_dir: str="raw_data",
                                   output_dir: str="selectedStats_from1980") -> None:
    """
...
def knn_impute_data_csv(start_year: int=1980, end_year: int=2025, k: int=10,
                         data_dir: str="selectedStats_from1980") -> None:
    """
...
def main(start=1980, end=2025):
    ...
    # Run pipeline steps
    create_pipeline_selectedStats_from1980(year_start, year_end)
