...
# (e.g., G / GS / MP / FG / FGA / FG% / 3P / 3PA / 3P% / 2P / 2PA / 2P% / eFG%
#        FT / FTA / FT% / ORB / DRB / TRB / STL / BLK / TOV / PF / AST / PTS),
...
def create_pipeline_allStats_from1980(start_year: int=1980, end_year: int=2025,
                                   raw_data_dir: str="raw_data",
                                   output_dir: str="allStats_from1980") -> None:
    """
...
def knn_impute_data_csv(start_year: int=1980, end_year: int=2025, k: int=10,
                         data_dir: str="allStats_from1980") -> None:
    """
...
def normalize_data_csv(start_year: int=1980, end_year: int=2025,
                        data_dir: str="allStats_from1980") -> None:
    """
...
def check_processed_data_integrity(start_year: int=1980, end_year: int=2025,
                                   data_dir: str="allStats_from1980") -> None:
    """
...
def main(start=1980, end=2025):
    ...
    # Run pipeline steps
    create_pipeline_allStats_from1980(year_start, year_end)
